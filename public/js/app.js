...
},{"../compiler":20,"../util":73,"_process":1}],16:[function(require,module,exports){
(function (process){
var _ = require('./util')
var config = require('./config')
...
},{"./config":22,"./util":73,"_process":1}],17:[function(require,module,exports){
/**
...
},{"../config":22,"../directives/internal/prop":30,"../parsers/directive":61,"../parsers/path":63,"../util":73,"_process":1}],19:[function(require,module,exports){
(function (process){
var _ = require('../util')
...
},{"../directives/internal":29,"../directives/public":39,"../parsers/directive":61,"../parsers/template":64,"../parsers/text":65,"../util":73,"./compile-props":18,"_process":1}],20:[function(require,module,exports){
var _ = require('../util')
...
},{"../parsers/template":64,"../util":73,"_process":1}],22:[function(require,module,exports){
module.exports = {
...
},{"./parsers/expression":62,"./util":73,"./watcher":77,"_process":1}],24:[function(require,module,exports){
...
},{"../../fragment/factory":51,"../../util":73,"../public/if":38,"_process":1}],26:[function(require,module,exports){
var _ = require('../../util')
var templateParser = require('../../parsers/template')
...
},{"../../parsers/template":64,"../../util":73,"_process":1}],29:[function(require,module,exports){
...
},{"../../util":73,"_process":1}],34:[function(require,module,exports){
module.exports = {
  bind: function () {
    var el = this.el
...
},{"../../fragment/factory":51,"../../util":73,"_process":1}],37:[function(require,module,exports){
var _ = require('../../util')
var templateParser = require('../../parsers/template')
...
},{"../../fragment/factory":51,"../../util":73,"_process":1}],39:[function(require,module,exports){
// text & html
...
},{"../../../util":73,"./checkbox":40,"./radio":42,"./select":43,"./text":44,"_process":1}],42:[function(require,module,exports){
var _ = require('../../../util')
...
},{"../../util":73,"_process":1}],46:[function(require,module,exports){
(function (process){
if (process.env.NODE_ENV !== 'production') {
  module.exports = {
    bind: function () {
...
},{"../../util":73,"_process":1}],47:[function(require,module,exports){
var _ = require('../../util')
var transition = require('../../transition')
...
},{"../util":73,"_process":1}],54:[function(require,module,exports){
...
},{"../util":73,"_process":1}],57:[function(require,module,exports){
(function (process){
var _ = require('../util')
var compiler = require('../compiler')
...
},{"../compiler":20,"../observer":60,"../observer/dep":59,"../util":73,"../watcher":77,"_process":1}],58:[function(require,module,exports){
var _ = require('../util')
var arrayProto = Array.prototype
...
},{"../cache":17,"../util":73,"./path":63,"_process":1}],63:[function(require,module,exports){
(function (process){
var _ = require('../util')
var Cache = require('../cache')
...
},{"../cache":17,"../util":73,"_process":1}],64:[function(require,module,exports){
var _ = require('../util')
var Cache = require('../cache')
...
},{"./index":73,"_process":1}],70:[function(require,module,exports){
(function (process){
/**
...
},{"../config":22,"_process":1}],71:[function(require,module,exports){
(function (process){
var _ = require('./index')
var config = require('../config')
var transition = require('../transition')
...
},{"../config":22,"../transition":66,"./index":73,"_process":1}],72:[function(require,module,exports){
...
},{"../config":22,"./index":73,"_process":1}],76:[function(require,module,exports){
(function (process){
var _ = require('./util')
var extend = _.extend
...
},{"./api/data":11,"./api/dom":12,"./api/events":13,"./api/global":14,"./api/lifecycle":15,"./directives/element":24,"./directives/public":39,"./filters":50,"./instance/events":53,"./instance/init":54,"./instance/lifecycle":55,"./instance/misc":56,"./instance/state":57,"./util":73,"_process":1}],77:[function(require,module,exports){
(function (process){
var _ = require('./util')
var config = require('./config')
var Dep = require('./observer/dep')
...
},{"./batcher":16,"./config":22,"./observer/dep":59,"./parsers/expression":62,"./util":73,"_process":1}],78:[function(require,module,exports){
'use strict';
...
var vm = new Vue({
  ...
  events: {
    'load-terms': function loadTerms() {
      this.loadTerms();
    },
    //'create-term': function() {
    //  console.log(arguments);
    //},
    'destroy-term': function destroyTerm(term) {
  ...
  methods: {
    ...
    destroyTerm: function destroyTerm(term) {
...
},{"./components/modal/modal":79,"./components/term-table/term-table":82,"lodash":2,"vue":76,"vue-resource":4}],79:[function(require,module,exports){
// Vuestrap ftw
...
module.exports = '<div style="display: none">\n    <div id="{{id}}" class="modal" :class="{fade: fade, in: animateModal || !fade}" style="display: block" v-on:click="onClickOut($event)">\n        <div class="modal-dialog modal-{{size}}" role="document" style="z-index: 9999">\n            <div class="modal-content">\n                <div class="modal-header">\n                    <slot name="header"></slot>\n                </div>\n                <div class="modal-body">\n                    <slot name="body"></slot>\n                </div>\n                <div class="modal-footer">\n                    <slot name="footer"></slot>\n                </div>\n            </div>\n        </div>\n    </div>\n    <div class="modal-backdrop" :class="{fade: fade, in: animateBackdrop || !fade}"></div>\n</div>';
},{}],81:[function(require,module,exports){
module.exports = '<table class="Terms_List table table-striped" v-if="terms.length">\n    <tr v-for="term in terms | iSortBy \'name\'" data-id="{{term.id}}">\n        <td v-text="term.acronym || term.name"></td>\n        <td v-text="term.definition | truncate 75"></td>\n        <td>\n            <div class="btn-group actions" role="group" aria-label="Basic example">\n                <button v-on:click="edit(term)" class="btn btn-secondary"><i class="fa fa-cog"></i></button>\n                <!--<button v-on:click="alias(term)" class="btn btn-secondary"><i class="fa fa-clone"></i></button>-->\n                <button v-on:click="destroy(term)" class="btn btn-secondary"><i class="fa fa-trash"></i></button>\n            </div>\n        </td>\n    </tr>\n</table>';
...
module.exports = {
  ...
  methods: {
    edit: function edit(term) {
      this.$broadcast('edit-term', term);
    },
    alias: function alias(term) {
      this.$broadcast('alias-term', term);
    },
    destroy: function destroy(term) {
  ...
  filters: {
    truncate: function truncate(content, chars) {
    ...
    iSortBy: function iSortBy(arr, sortKey, reverse) {
      var order = reverse && reverse < 0 ? -1 : 1;
      // sort on a copy to avoid mutating original array
      return arr.slice().sort(function (a, b) {
